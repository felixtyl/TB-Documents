...
export default function App() {
  ...
  // ---------- Derived ----------
  // These hooks must run on every render regardless of auth state, so they sit
  // above every early return below. docs/submissions default to [] until data
  // loads, which is a safe input for all of these.
